...
def edit_education(request,pid):
    ...
    if request.method == "POST":
        ...
        user.schoolclgssc = schoolclgssc
        user.yearofpassingssc = yearofpassingssc
        user.percentagessc = percentagessc

        user.coursehsc = coursehsc
        user.schoolclghsc = schoolclghsc
        user.yearofpassinghsc = yearofpassinghsc
        user.percentagehsc = percentagehsc
    
        user.coursegra = coursegra
        user.schoolclggra = schoolclggra
        user.yearofpassinggra = yearofpassinggra
        user.percentagegra = percentagegra

        user.coursepg = coursepg
        user.schoolclgpg = schoolclgpg
